...
const SITE = {
  ...
  proyectos: [
    ...
    },
    {
      ...
      resumen:
        "Aula Impulsa 4.0 para el liceo técnico-profesional de María Elena: diseñada junto a su comunidad, habilitada en terreno e inaugurada en septiembre de 2025.",
      img: "assets/img/proyectos/aula-impulsa-maria-elena/00-portada.jpg",
      img_credito: "Alianza CCM-Eleva",
      bloques: [
        { tipo: "texto", valor: "Un Aula Impulsa para el Liceo H.C. T.P. María Elena, en la región de Antofagasta. Impulsa 4.0 es un programa de Fundación Chile que financian Antofagasta Minerals, BHP, Codelco, Novandino Litio y SQM, y que busca acercar a estudiantes y docentes a cuatro tecnologías de la industria 4.0: robótica, realidad virtual y aumentada, programación y prototipado. Ideo Maker ejecutó el proyecto completo, desde el diseño participativo hasta la capacitación de los docentes, en paralelo con el aula del Liceo Bicentenario Agropecuario Likan Antai, en San Pedro de Atacama." },
        ...
        { tipo: "texto", titulo: "El co-diseño", valor: "La primera etapa fue en terreno, en abril de 2025: una entrevista con el equipo directivo, una feria maker con encuesta a los estudiantes, un focus group con docentes y un levantamiento técnico de la sala. Lo que salió de ahí definió la distribución del espacio, las tecnologías que se compraron y las obras que había que hacer antes de instalar nada." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/01-render-interior.jpg", pie: "El aula, modelada en Unreal Engine antes de construirse." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/02-render-patio.jpg", pie: "El patio, en el modelo." },
        { tipo: "texto", titulo: "La habilitación", valor: "La sala no estaba lista para recibir tecnología. La red eléctrica tenía pocos puntos y ninguna distribución bajo las mesas, no había climatización y el mobiliario estaba empotrado, así que no se podía reorganizar por estaciones. Por eso el proyecto sumó electricidad, climatización y pintura interior y exterior a la compra de equipos y mobiliario. La sala se pintó con la paleta de Ideo Maker." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/10-sala.jpg", pie: "El aula terminada, con las zonas de realidad virtual, electrónica e impresión 3D.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/11-sala-completa.jpg", pie: "Robótica y pañol al fondo.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/12-herramientas.jpg", pie: "El muro de herramientas.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/13-sala-mesas.jpg", pie: "Las mesas de trabajo.", credito: "Alianza CCM-Eleva" },
        { tipo: "texto", titulo: "La capacitación docente", valor: "Entre octubre y noviembre de 2025 se capacitó al equipo docente en fabricación digital, realidad virtual, programación y robótica educativa. Cada tecnología tuvo dos sesiones presenciales, una actividad asincrónica y una bitácora donde cada docente registró sus prototipos. El orden de los módulos lo pusieron los propios docentes durante el co-diseño, partiendo por lo que podían usar al día siguiente." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/18-capacitacion-robotica.jpg", pie: "Robótica educativa con MK-BOT, el kit de Ideo Maker." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/18-capacitacion-prototipo.jpg", pie: "Una docente trabajando con el kit de domótica." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/19-capacitacion-programacion.jpg", pie: "La sesión de programación." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-maria-elena/19-capacitacion-realidad-virtual.jpg", pie: "La sesión de realidad virtual." },
        { tipo: "texto", valor: "El aula se inauguró el 2 de septiembre de 2025 y quedó con garantía, mantención y acompañamiento técnico y pedagógico hasta agosto de 2026." },
    ...
    },
    {
      ...
      tags: ["FabLab", "Diseño de espacios", "Capacitación docente", "Modelado 3D", "Educación"],
      resumen:
        "Aula Impulsa 4.0 para el liceo técnico-profesional de Taltal: diseñada y recorrida en 3D, habilitada en terreno e inaugurada en junio de 2026.",
      img: "assets/img/proyectos/aula-impulsa-taltal/21-en-el-aula.jpg",
      img_credito: "Alianza CCM-Eleva",
      bloques: [
        ...
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/06-acceso.jpg", pie: "El acceso al aula, en el modelo." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/01-muro-panol.jpg", pie: "El muro del pañol, el router CNC, la robótica y la codificación." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/02-muro-fabricacion.jpg", pie: "El muro de impresión 3D y fabricación digital." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/03-muro-laser.jpg", pie: "El muro de corte láser." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/04-muro-realidad-virtual.jpg", pie: "La zona de realidad virtual y la señalética de seguridad." },
        { tipo: "texto", titulo: "La inauguración", valor: "El aula se inauguró a comienzos de junio de 2026, junto con la del Liceo Minero América de Calama. Se diseñó en un proceso de co-diseño con la comunidad del liceo y se suma a la red de aulas que ya funcionan en Likan Antai y María Elena." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/20-ceremonia.jpg", pie: "Autoridades, docentes y equipos al cierre de la ceremonia.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/21-en-el-aula.jpg", pie: "En el aula, durante la inauguración.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/22-recorrido.jpg", pie: "El recorrido por el aula, junto al muro del router CNC.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/23-discurso.jpg", pie: "Uno de los discursos de la ceremonia.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/24-discurso.jpg", pie: "Otro de los discursos.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/25-comunidad.jpg", pie: "La comunidad del liceo, el día de la inauguración.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-taltal/26-estudiantes.jpg", pie: "Estudiantes durante la jornada.", credito: "Alianza CCM-Eleva" },
        { tipo: "enlaces", titulo: "En la prensa", valor: [
          { texto: "Álbum de fotos de la inauguración", fuente: "Alianza CCM-Eleva · Flickr", url: "https://www.flickr.com/photos/alianza-ccm-eleva/albums/72177720333909734/" },
          { texto: "Taltal y Calama cuentan con nuevas Aulas STEM", fuente: "Fundación Chile · nota y fotos oficiales · junio de 2026", url: "https://fch.cl/noticias/taltal-y-calama-cuentan-con-nuevas-aulas-stem-para-impulsar-la-educacion-del-futuro/" },
          { texto: "Aulas STEM en Taltal y Calama impulsan educación para la minería 4.0", fuente: "Reporte Minero · junio de 2026", url: "https://www.reporteminero.cl/noticia/noticias/2026/06/aulas-stem-taltal-calama-mineria-4-0-antofagasta" }
        ] },
      ]
    },
    {
      ...
      img: "assets/img/proyectos/aula-impulsa-calama/14-equipo-en-el-aula.jpg",
      img_credito: "Alianza CCM-Eleva",
      bloques: [
        ...
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/08-plano-sala.jpg", pie: "La sala, la vía de evacuación y el área de uso común." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/05-planta.jpg", pie: "La planta del aula, con sus zonas de trabajo." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/06-acceso.jpg", pie: "El acceso al aula, en el modelo." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/01-muro-fabricacion.jpg", pie: "El muro de impresión 3D y fabricación digital." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/02-muro-panol.jpg", pie: "El muro del pañol y la señalética de seguridad." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/03-muro-laser.jpg", pie: "El muro de corte láser, router CNC, robótica y codificación." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/04-muro-realidad-virtual.jpg", pie: "La zona de realidad virtual." },
        { tipo: "texto", titulo: "El aula en uso", valor: "El día de la inauguración, estudiantes y docentes ya estaban usando cada zona del aula." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/10-realidad-virtual.jpg", pie: "La zona de realidad virtual.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/11-pizarra-interactiva.jpg", pie: "La pizarra interactiva.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/12-robotica.jpg", pie: "Estudiantes en la zona de robótica.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/13-impresion-3d.jpg", pie: "La zona de impresión 3D.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/14-equipo-en-el-aula.jpg", pie: "Docentes, estudiantes y equipos en el aula.", credito: "Alianza CCM-Eleva" },
        { tipo: "texto", titulo: "La inauguración", valor: "El aula se inauguró a comienzos de junio de 2026, junto con la del Liceo José Miguel Quiroz de Taltal. Se diseñó en un proceso de co-diseño con la comunidad del liceo y se suma a la red de aulas que ya funcionan en Likan Antai y María Elena." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/20-autoridades.jpg", pie: "Autoridades y equipos, el día de la inauguración.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/21-autoridades-en-el-aula.jpg", pie: "En el aula, durante la inauguración.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/22-asistentes.jpg", pie: "Asistentes a la ceremonia.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/23-comunidad.jpg", pie: "La comunidad del liceo, el día de la inauguración.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-calama/24-escenario.jpg", pie: "El cierre de la ceremonia.", credito: "Alianza CCM-Eleva" },
        { tipo: "enlaces", titulo: "En la prensa", valor: [
          { texto: "Álbum de fotos de la inauguración", fuente: "Alianza CCM-Eleva · Flickr", url: "https://www.flickr.com/photos/alianza-ccm-eleva/albums/72177720333912187/" },
          { texto: "Taltal y Calama cuentan con nuevas Aulas STEM", fuente: "Fundación Chile · nota y fotos oficiales · junio de 2026", url: "https://fch.cl/noticias/taltal-y-calama-cuentan-con-nuevas-aulas-stem-para-impulsar-la-educacion-del-futuro/" },
          { texto: "Codelco impulsa educación STEM en Calama con Aula 4.0", fuente: "Reporte Minero · junio de 2026", url: "https://www.reporteminero.cl/noticia/noticias/2026/06/codelco-aula-impulsa-4-0-liceo-minero-america-calama" },
          { texto: "Calama suma nueva Aula Impulsa 4.0", fuente: "Diario El América · 27 de junio de 2026", url: "https://elamerica.cl/2026/06/27/con-el-apoyo-de-codelco-calama-suma-nueva-aula-impulsa-4-0-para-acercar-a-estudiantes-a-la-educacion-stem-y-a-la-mineria-del-futuro/" }
        ] },
      ]
    },
    {
      ...
      tags: ["FabLab", "Diseño de espacios", "Capacitación docente", "Modelado 3D", "Educación"],
      resumen:
        "Aula Impulsa 4.0 para el liceo agropecuario de San Pedro de Atacama: diseñada junto a su comunidad, habilitada en terreno e inaugurada en septiembre de 2025.",
      img: "assets/img/proyectos/aula-impulsa-likan-antai/00-portada.jpg",
      img_credito: "Alianza CCM-Eleva",
      bloques: [
        { tipo: "texto", valor: "Un Aula Impulsa para el Liceo Bicentenario Agropecuario Likan Antai, en San Pedro de Atacama. Impulsa 4.0 es un programa de Fundación Chile que financian Antofagasta Minerals, BHP, Codelco, Novandino Litio y SQM, y que busca acercar a estudiantes y docentes a cuatro tecnologías de la industria 4.0: robótica, realidad virtual y aumentada, programación y prototipado. Ideo Maker ejecutó el proyecto completo, desde el diseño participativo hasta la capacitación de los docentes, en paralelo con el aula del Liceo H.C. T.P. María Elena." },
        { tipo: "lista", titulo: "Mi rol", valor: ["Diseño del espacio y modelo 3D en Unreal Engine", "Presupuestos, carta Gantt y logística", "Habilitación en terreno: armado e instalación del mobiliario", "Capacitación docente en las cuatro tecnologías"] },
        { tipo: "lista", titulo: "Equipo Ideo Maker", valor: ["Sebastián Higuera", "Patricia Ramírez", "Vicente Cáceres", "Nelson Mora", "Javiera Matus", "Diego López"] },
        { tipo: "texto", titulo: "El co-diseño", valor: "La primera etapa fue en terreno, en abril de 2025: una entrevista con el equipo directivo, una feria maker con encuesta a los estudiantes, un focus group con docentes y un levantamiento técnico de la sala. Lo que salió de ahí definió la distribución del espacio, las tecnologías que se compraron y las obras que había que hacer antes de instalar nada." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/01-render-interior.jpg", pie: "El aula, modelada en Unreal Engine antes de construirse." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/02-render-exterior.jpg", pie: "El exterior y el patio, en el modelo." },
        { tipo: "texto", titulo: "La habilitación", valor: "La sala elegida era uno de los laboratorios de computación del liceo, con puestos fijos de trabajo individual. La red eléctrica no alcanzaba para instalar tecnología en los muros y había un solo aire acondicionado, en mal estado. Por eso el proyecto sumó electricidad, climatización y pintura a la compra de equipos y mobiliario. La sala se pintó con la paleta de Ideo Maker." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/10-sala.jpg", pie: "El aula terminada.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/11-electronica.jpg", pie: "La zona de electrónica.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/12-impresion-3d.jpg", pie: "La zona de impresión 3D.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/13-cnc.jpg", pie: "El router CNC.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/14-laser.jpg", pie: "La cortadora láser.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/15-herramientas.jpg", pie: "El muro de herramientas.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/16-realidad-virtual.jpg", pie: "La zona de realidad virtual.", credito: "Alianza CCM-Eleva" },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/17-prototipado-panol.jpg", pie: "Prototipado y pañol.", credito: "Alianza CCM-Eleva" },
        { tipo: "texto", titulo: "La capacitación docente", valor: "Entre octubre y noviembre de 2025 se capacitó al equipo docente en fabricación digital, realidad virtual, programación y robótica educativa. Cada tecnología tuvo dos sesiones presenciales, una actividad asincrónica y una bitácora donde cada docente registró sus prototipos. El orden de los módulos lo pusieron los propios docentes durante el co-diseño, partiendo por lo que podían usar al día siguiente." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/18-capacitacion-sesion.jpg", pie: "Una sesión de capacitación en el aula." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/18-capacitacion-impresion-3d.jpg", pie: "Una pieza recién impresa en 3D." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/19-capacitacion-robotica.jpg", pie: "Robótica educativa con MK-BOT." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/19-capacitacion-domotica.jpg", pie: "Docentes trabajando con el kit de domótica." },
        { tipo: "texto", valor: "El aula se inauguró el 2 de septiembre de 2025 y quedó con garantía, mantención y acompañamiento técnico y pedagógico hasta agosto de 2026." },
        { tipo: "imagen", valor: "assets/img/proyectos/aula-impulsa-likan-antai/20-inauguracion.jpg", pie: "La inauguración.", credito: "Alianza CCM-Eleva" },
